...
_G.packer_plugins = {
  ...
  ["gruvbox-material"] = {
    loaded = true,
    path = "/home/mark/.local/share/nvim/site/pack/packer/start/gruvbox-material",
    url = "https://github.com/sainnhe/gruvbox-material"
  },
  ["impatient.nvim"] = {
    config = { 'require("impatient")' },
    loaded = true,
    path = "/home/mark/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["tabby.nvim"] = {
    loaded = true,
    path = "/home/mark/.local/share/nvim/site/pack/packer/start/tabby.nvim",
